        ...
        <div className="max-w-5xl mx-auto border-t border-black/10 pt-20">
          ...
          <motion.div variants={fadeUp} className="flex flex-col items-center">
            ...
            <button
              ...
              className="bg-[#171717] text-white px-8 py-4 rounded-full font-bold text-lg md:text-xl transition-all duration-300 ease-out hover:bg-black hover:scale-105 flex items-center justify-center gap-3 group"
            >
