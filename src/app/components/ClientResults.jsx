...
const ClientResults = () => {
  return (
    <section className="flex flex-col relative lg:flex-row items-center justify-between bg-[#efebe5] text-black px-4 lg:ml-16 max-w-full py-8 lg:py-12">
      ...
      <div className="flex flex-col items-center lg:items-start max-w-full sm:mt-4 mt-8 lg:mt-20 z-10 backdrop-blur-[2px] lg:max-w-1/2 text-center lg:text-left mb-8 lg:mb-0 px-4 lg:px-0">
        <BasicChips label="Client Results" />
        <h1 className="text-2xl sm:text-3xl lg:text-4xl">Astrix Media —</h1>
      ...
      {/* Right Side */}
      <div className="flex justify-center items-center w-full lg:w-auto z-0 mt-4 lg:mt-0">
        <Image 
        src="/AstrixLogo.png" 
        width={500} 
        height={500} 
