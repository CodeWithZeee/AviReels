...
const Mobile = () => {
  return (
    <div className="relative flex justify-center h-[300px] w-40 border-4  border-black rounded-2xl bg-gray-50" style={{boxShadow: '5px 5px 2.5px 6px rgb(209, 218, 218)'}}>
