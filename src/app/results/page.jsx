  ...
  const cases = [
    {
      ...
      stats: [
        ...
        {
          value: "$1,000+",
          text: "per month in recurring ad revenue within the first quarter",
        },
        {
          value: "70M views",
          text: "on a single video, outperforming 99.9% of all YouTube Shorts ever published",
        },
      ],
    },
    {
      ...
      stats: [
        ...
        {
          value: "Multiple 7-figure clients",
          text: "booked directly from the creatives",
        },
        {
          value: "High-ticket proof",
          text: "that AI avatar ads perform at the highest levels of the market",
        },
      ],
    },
    {
      ...
      stats: [
        ...
        {
          value: "High volume",
          text: "of inbound calls booked within 2 months on Meta",
        },
        {
          value: "Proof",
          text: "that a small volume of the right creatives outperforms a large volume of the wrong ones",
        },
      ],
    },
    {
      ...
      stats: [
        ...
        {
          value: "4.5M",
          text: "combined impressions from the top two videos alone",
        },
      ],
    },
    {
      ...
      stats: [
        {
          value: "$3,700",
          text: "in direct sales from a single AI avatar VSL",
        },
    ...
    },
    {
      ...
      stats: [
        ...
        {
          value: "Proof",
          text: "that the production quality holds well beyond digital native brands",
        },
      ],
    },
  ];
    ...
    <div className="bg-[#F4F2EC] min-h-screen pt-32 pb-20 overflow-hidden text-[#111111]">
      ...
      >
        ...
        >
          ...
          Real Numbers.
          <br />
          <span className="text-gray-500 font-medium italic font-serif">
            No Projections.
          </span>
        </motion.h1>
        <motion.p
        ...
        >
          Every result on this page is documented. Every client is real. This is
      ...
      >
        <p className="text-xl md:text-3xl gilroy font-medium text-gray-500">
          These are the results made public.
          <br />
          Yours could be next.
        </p>
      </motion.section>
      ...
      >
        ...
        >
          Results like these are available.
          <br />
        ...
        >
          Every brand on this page started with one conversation. Every number
          above came from the same system that is available right now.
        </motion.p>
        <motion.p
          variants={fadeUp}
          className="text-lg md:text-xl text-gray-600 gilroy font-medium max-w-2xl mx-auto mb-12 leading-relaxed"
        >
          Every day without a production system behind you is a day your
          competitors are posting, growing, and pulling further ahead. That gap
          does not pause while you decide. <br />
          <br />
